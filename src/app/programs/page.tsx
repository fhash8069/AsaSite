        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex space-x-10">
              ...
              <a href="/programs" className="font-semibold text-amber-600" style={{color: '#7f1d1d'}}>PROGRAMS</a>
      ...
      <section className="py-20 relative overflow-hidden" style={{backgroundColor: '#f9fafb'}}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            <a href="/contact" className="bg-burgundy-700 hover:bg-burgundy-800 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors border-2 border-burgundy-700">
              Join Our Programs
            </a>
            <a href="/events" className="border-2 border-burgundy-700 hover:bg-burgundy-700 hover:text-white text-burgundy-700 px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
